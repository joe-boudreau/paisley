...
export class WalletService {
    ...
    async getWalletOrGenerate(username: string): Promise<WalletInfo> {
        try {
            ...
            // User MSP Identity
            const userMspPath = path.join(`../../network/crypto-config/peerOrganizations/org1.companyABC.com/users/${username}@org1.companyABC.com/msp`)
            ...
            // User TLS Identity
            const userTlsPath = path.join(`../../network/crypto-config/peerOrganizations/org1.companyABC.com/users/${username}@org1.companyABC.com/tls`)
